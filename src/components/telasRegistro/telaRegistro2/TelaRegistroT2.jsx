    ...
    <div className="containerT2">
      ...
      <form className="formT2">
        ...
        <div className="botoes">
          ...
          <button className="Cadastro-Normal" onClick={props.avancarRegistro2}>
            Cadastrar
          </button>
          <span>OU</span>
          <div className="responsividadeBotoes">
            <button className="Cadastro-Facebook">
              <FaFacebook /> <span>Continuar com Facebook</span>
            </button>
            <button className="Cadastro-Google">
              <FcGoogle />
